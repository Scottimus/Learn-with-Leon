...
function underGroundPokemonLeague(partySize){
    for(let i = 1; i <= partySize.length; i++){//.length added for array being passed in
        console.log('Pikachu I choose you')

    }
}

//underGroundPokemonLeague(6) //if it was just an amount passed in.
underGroundPokemonLeague(['bulbasaur','caterpie','weedle'])//If it is an array passed it